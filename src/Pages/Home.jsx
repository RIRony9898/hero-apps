     ...
     <Container>
      ...
      {/* google app store and apple app store buttons */}
        <div className="flex justify-center mt-10 gap-5">
            <Link to={'https://play.google.com/store/games?hl=en&pli=1'} target="_blank" className="btn btn-outline btn-primary rounded-full px-8">
                <img src="https://img.icons8.com/ios-filled/24/000000/google-play.png" alt="google play icon"/>
                Google Play
            </Link>
            <Link to={'https://www.apple.com/app-store/'} target="_blank" className="btn btn-outline btn-primary rounded-full px-8">
                <img src="https://img.icons8.com/ios-filled/24/000000/mac-os.png" alt="apple icon"/>
                App Store
            </Link>
        </div>
        {/* banner section */}
